...
<div class="col-md-12" ng-controller="keyWordsListCtrl">
                  ...
                  <h4 class="panel-title">
                        ...
                        <div class="dropdown pull-right" id="settings-dropdown<* keyWordsList.id *>" style="cursor:pointer; padding:0px; margin:1px">
                          ...
                          <ul class="dropdown-menu"
                            ...
                            <li role="presentation" style="padding-top: 5px;" ng-click="show_add_link_modal(keyWordsList.id)">
                            <span style="cursor:pointer;">
                                <label>
                                    <span
                                        style="margin-left: 15px; padding-top: 5px; cursor:pointer;"
                                        ng-click="show_add_link_modal(keyWordsList.id)"
                                        ng-checked="keyWordsList.original_content">
                                    Add link
                                    </span>
                                </label>
    ...
    @include('__modals__.keywords_list.addLink')
</div>
